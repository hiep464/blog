            ...
            <div className="flex flex-col justify-center items-center">
                <div className='item1 pt-[2%] pb-[2.5%] bg-[white] w-full flex justify-center items-center'>
                    <div className="max-w-[1200px] px-[20px] md:px-[30px]">
                        <div className="text-[24px] text-[#082C70] font-[700] mb-[15px] mt-[10px] md:mt-0">
                            BÀI VIẾT MỚI
                        </div>
                        <div class="row !grid sm:grid-cols-1 md:grid-cols-3  mb-[15px]">
                            <div class="w-full">
                                <Link to="/detail/1" class="card border-0 border-none bg-white no-underline ">
                                    ...
                                    <div class="card-body py-[10px] px-[10px] home-text">
                                        <p class="card-text text-[17px] font-[500]">
                                            Chồng mất sớm, tôi nhận con nuôi nhưng khi thằng bé lớn tôi phát hiện bí mật
                                            động trời
                                        </p>
                                    </div>
                                </Link>
                            ...
                            <div class="w-full">
                                <div class="card border-0 bg-white no-underline object-cover">
                                    <div className="md:h-[215px] overflow-hidden">
                                        <img
                                            className="hover:scale-110 transition-all duration-[300ms] w-full h-full "
                                            src={item2}
                                            alt="..."
                                        />
                                    </div>
                        ...
                        <div className="md:pb-[25px]">
                            ...
                            <div className="w-full flex-row justify-between items-start hidden md:flex">
                                ...
                                <div className="w-[50%] text-black ml-[10px] mt-[10px]">
                                    ...
                                    <div className="text-[17px] font-[500] py-[10px] home-text">
                                        Điều kì diệu của một cặp đôi suýt ly hôn vì “cơn say nắng” của vợ với đồng
                                        nghiệp
                                    </div>
                                    <div className="text-[14px] text-[#c6c6c6] font-[400] text-5-line ">
                                        “Làn gió lạ” chốn công sở Đó là vào khoảng năm 2003, khi tôi 28 tuổi và có mặt ở
                                        New York để tiếp xúc với đại diện các chi nhánh của công ty tôi. Lần đầu Andreas
                                        xuất hiện ở sảnh khách sạn để đón tôi tới văn phòng, tôi đã cảm thấy anh
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex flex-col md:flex-row">
                                <div className="w-full flex flex-col justify-center items-center mb-[40px] md:mb-0 md:mr-[3%]">
                                    ...
                                    <div className=" ml-[10px] mt-[5px]">
                                        ...
                                        <div className="text-[14px] text-[#c6c6c6] font-[400] text-5-line ">
                                            “Làn gió lạ” chốn công sở Đó là vào khoảng năm 2003, khi tôi 28 tuổi và có
                                            mặt ở New York để tiếp xúc với đại diện các chi nhánh của công ty tôi. Lần
                                            đầu Andreas xuất hiện ở sảnh khách sạn để đón tôi tới văn phòng, tôi đã cảm
                                            thấy anh
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div>
                            <div className="flex flex-row justify-center items-start mb-[15px]">
                                ...
                                <div className="pl-[10px] w-[66%]">
                                    <div class="text-[#99cc00]  card-text text-[14px] font-[500] leading-[120%] text-left">
                            ...
                            <div className="flex flex-row justify-center items-start mb-[15px]">
                                <img
                                    className="w-[33%] border-[3px] border-solid border-[white]"
                                    src={item1}
                                    alt="..."
                                />
                                <div className="pl-[10px] w-[66%]">
                                    ...
                                    <div className="mt-[5px] text-[#333333]  card-text text-[14px] font-[400] leading-[140%] text-left">
                                        "Em đừng kì vọng quá vào hôn nhân, anh xin nói với em một điều như vậy. Yêu
                                        không như lúc cưới"
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-start !grid grid-cols-1 md:grid-cols-4">
                            <div class="w-full pb-[10px] md:pb-0">
                                <iframe
                                    ...
                                    width="640"
                                    height="360"
                                    src="https://www.youtube.com/embed/zoIHNh5O_xQ?feature=oembed"
                                    frameborder="0"
                            ...
                            <div class="w-full pb-[10px] md:pb-0">
                                <iframe
                                    title="Cách để một mối tình đẹp không còn dang dở | ĐCNNTK #4"
                                    width="640"
                                    height="360"
                                    src="https://www.youtube.com/embed/6ZrQxrH_2YQ?feature=oembed"
                                    frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                    allowfullscreen=""
                                    className="h-[225px] md:h-[150px] w-full"
                            ...
                            <div class="w-full pb-[10px] md:pb-0">
                                <iframe
                                    title="Top 5 Câu Chuyện Hay Về Tình Yêu Hôn Nhân Nên Dành Vài Phút Để Nghe"
                                    width="640"
                                    height="360"
                                    src="https://www.youtube.com/embed/JgJiLrNRxl8?feature=oembed"
                                    frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                    allowfullscreen=""
                                    className="h-[225px] md:h-[150px] w-full"
                            ...
                            <div class="w-full pb-[10px] md:pb-0">
                                <iframe
                                    title="Những câu nói hay về tình yêu và cuộc sống đáng để chúng ta phải suy ngẫm"
                                    width="640"
                                    height="480"
                                    src="https://www.youtube.com/embed/8bWfxdzSlNU?feature=oembed"
                                    frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                    allowfullscreen=""
                                    className="h-[225px] md:h-[150px] w-full"
                ...
                <div className="w-full max-w-[1200px] px-[20px] md:px-[30px] mt-[20px] md:mt-[50px] mb-[10px] md:mb-[50px]">
                    ...
                    <div className="flex flex-col md:flex-row">
                        <div className="w-full flex flex-col justify-center items-center pb-[30px] md:pb-0 md:mr-[3%]">
                            ...
                            <div className=" ml-[10px] mt-[5px]">
                                <div className="text-[17px] font-[500] py-[10px] text-center">
                                    Điều kì diệu của một cặp đôi suýt ly hôn vì “cơn say nắng” của vợ với đồng nghiệp
                                </div>
                                <div className="text-[14px] text-[#c6c6c6] font-[400] text-5-line">
                                    “Làn gió lạ” chốn công sở Đó là vào khoảng năm 2003, khi tôi 28 tuổi và có mặt ở New
                                    York để tiếp xúc với đại diện các chi nhánh của công ty tôi. Lần đầu Andreas xuất
                                    hiện ở sảnh khách sạn để đón tôi tới văn phòng, tôi đã cảm thấy anh
                                </div>
                            </div>
                        </div>
                        <div className="w-full flex flex-col justify-center items-center pb-[30px] md:pb-0 md:mr-[3%]">
